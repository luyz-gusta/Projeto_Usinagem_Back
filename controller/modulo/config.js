...
const ERROR_INVALID_ID_MATERIA_CURSO = {status: 400, message: 'O ID DA MATERIA OU DE CURSO INFORMADO NA REQUISIÇÃO NÃO É VALIDADO, OU NÃO FOI ENCAMINHADO'}
...
const ERROR_INVALID_VALOR = {status: 400, message: 'O VALOR INFORMADO NA REQUISIÇÃO NÃO É VALIDADO, OU NÃO FOI ENCAMINHADO'}
...
const ERROR_INVALID_ID_MATRICULA = {status: 400, message: 'O ID DA MATRICULA INFORMADA NA REQUISIÇÃO NÃO É VALIDADA, OU NÃO FOI ENCAMINHADA'}
...
const ERROR_INVALID_ID_TURMA = {status: 400, message: 'O ID DA TURMA INFORMADA NA REQUISIÇÃO NÃO É VALIDADA, OU NÃO FOI ENCAMINHADA'}
